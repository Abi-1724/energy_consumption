...
model1 = joblib.load("model.pkl")  # Ridge
model2 = joblib.load("model2.pkl")  # ExtraTreesRegressor
model3 = joblib.load("model3.pkl")  # RandomForestRegressor
model4 = joblib.load("model4.pkl")  # GradientBoostingRegressor
model5 = joblib.load("model5.pkl")  # SVR
model6 = joblib.load("model6.pkl")  # ANN
